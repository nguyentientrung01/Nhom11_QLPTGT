 ...
 * @author DELL
 */
public class OtoUser extends javax.swing.JFrame {

    private String taikhoan;
    private String idxeclick;
    public OtoUser(String username) {
        initComponents();
        khoitaobang();
        taikhoan = username;
    }
...
//        panxemay.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        OtoModel xm = OtoController.getxeById(idxeclick);
        if(xm.getSoluong()<=0) {
