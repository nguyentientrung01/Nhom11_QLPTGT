 ...
 * @author DELL
 */
public class Oto_admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buthem = new javax.swing.JButton();
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/view/icon/oto_24.png"))); // NOI18N
        jLabel2.setText("Quản lý Ô tô");
        ...
        sxtheo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID xe  A-Z", "Tên xe A-Z", "Hãng xe A-Z", "Giá bán Thấp-Cao", "Năm s.xuất Cũ-Mới", "Số chỗ Ít-Nhiều" }));
        ...
        bangchinh.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdXe", "Tên", "Hãng xe", "Màu sac", "Giá bán", "Năm s.xuất", "Số lượng", "Số chỗ", "Nhiên liệu"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class
            };
        ...
        bangchinh.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                bangchinhAncestorAdded(evt);
            }
        ...
        tktheo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID Xe", "Tên Xe", "Hãng Xe", "Năm s.xuất", "Màu sắc", "Số chỗ", "Nhiên liệu" }));
        tktheo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tktheoActionPerformed(evt);
            }
        });
        ...
        buthem.setFont(new java.awt.Font("SansSerif", 1, 17)); // NOI18N
        buthem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/view/icon/them.png"))); // NOI18N
        buthem.setText("Thêm");
        buthem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buthemActionPerformed(evt);
            }
        });
        ...
        jLabel7.setText("Nhiên liệu");

        sc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2", "4", "5", "7", "9", "16", "24", "32", "48" }));
            ...
            .addGroup(panxemayLayout.createSequentialGroup()
                .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panxemayLayout.createSequentialGroup()
                        ...
                        .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panxemayLayout.createSequentialGroup()
                                .addComponent(buthem, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panxemayLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(nl, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
                ...
                .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panxemayLayout.createSequentialGroup()
                        ...
                        .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(buthem, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButton12, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(butxoa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(timkiemtheo.equals("Số chỗ")) timkiemtheo = "socho";
...
//        panxemay.setVisible(true);
    ...
    private void butxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butxoaActionPerformed
        ...
        if(OtoController.checkxeById(idxeclick)==false) {
        ...
        if(x==0) {
            if(OtoController.xoaxeById(idxeclick)) {
    ...
    private void buthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buthemActionPerformed
        String idxe = id.getText();
        String tenxe = ten.getText();
        String hangxe = String.valueOf(hang.getSelectedItem());
        String mauxe = mau.getText();
        int namsx = Integer.valueOf(String.valueOf(nam.getSelectedItem()));
        String dungtich = nl.getText();
        String slphu = sl.getText();
        String giabanphu = gia.getText();
        int socho = Integer.valueOf(sc.getSelectedIndex());
        int soluong; 
        int giaban;
        if(idxe.equals("") || tenxe.equals("") || mauxe.equals("") || giabanphu.equals("") || slphu.equals("") || dungtich.equals("")) {
        ...
        try {
            ...
            if(soluong < 0 || giaban < 0 || socho < 0) {
                JOptionPane.showMessageDialog(null, "Giá bán hoặc số lượng không được để giá trị âm");
                return;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Giá bán hoặc số lượng chưa đúng định dạng");
            return;
        }
        
        if(OtoController.checkxeById(idxe)) {
            JOptionPane.showMessageDialog(null, "ID xe đã tồn tại, bạn cần nhập id xe khác");
        }
        else {
            if(OtoController.luuoto(idxe, tenxe, hangxe, mauxe, giaban, namsx, soluong,socho, dungtich)) {
    ...
    }//GEN-LAST:event_buthemActionPerformed
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String nhienlieu = (String)bangchinh.getValueAt(rowclick, 8);
        String sochophu = "" + bangchinh.getValueAt(rowclick, 7);
        ...
        if(OtoController.checkxeById(idxe)==false) {
            JOptionPane.showMessageDialog(null, "ID xe cần cập nhật không tồn tại");
            return;
        }
        if(idxe.equals("") || tenxe.equals("") || mauxe.equals("") || giabanphu.equals("") || slphu.equals("") || nhienlieu.equals("")) {
            JOptionPane.showMessageDialog(null, "Bạn cần điền đầy đủ thông tin các cột");
            return;
        }
        try {
            ...
            socho = Integer.parseInt(sochophu);
            if(soluong < 0 || giaban < 0 || namsx < 0 || socho < 0 ) {
        ...
        if(x==0) {
            if(OtoController.updateoto(idxe, tenxe, hangxe, mauxe, giaban, namsx, soluong, socho, nhienlieu)) {
    ...
    private void sxtheoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sxtheoActionPerformed
        ...
        if(bangchon.contains("Số chỗ")) bangchon = "socho";
    ...
    private void bangchinhAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_bangchinhAncestorAdded
        
    }//GEN-LAST:event_bangchinhAncestorAdded

    private void tktheoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tktheoActionPerformed

        
    }//GEN-LAST:event_tktheoActionPerformed

    // --Phần sử lý dữ liệu 
     
    
    public void khoitaobang() {
        String[] column = {"IdXe","Tên","Hãng xe","Màu sắc","Giá bán","Năm s.xuất","Số lượng","Số chỗ","Nhiên liệu"};
        DefaultTableModel model = new DefaultTableModel();
        List<OtoModel> list = new ArrayList<>();
        list = OtoController.getAllOto();
        System.out.println(list.size());
        for (String x : column) {
            model.addColumn(x);
        }
        for (OtoModel t : list) {
            Object[] x = {t.getIdxe(),t.getTen(),t.getHangxe(),t.getMausac(),t.getGiaban(),t.getNamsx(),t.getSoluong(),t.getSocho(),t.getNhienlieu()};
            model.addRow(x);
        }
    ...
    public void bangtimkiem(String ndtimkiem,String timkiemtheo) {
        ...
        DefaultTableModel model = new DefaultTableModel();
        List<OtoModel> list = new ArrayList<>();
        list = OtoController.getAllByinfo(ndtimkiem, timkiemtheo);
        System.out.println(list.size());
        for (String x : column) {
            model.addColumn(x);
        }
    ...
    public void bangsapxep(String bangchon) {
        ...
        DefaultTableModel model = new DefaultTableModel();
        List<OtoModel> list = new ArrayList<>();
        list = OtoController.getOtoBysort(bangchon);
        System.out.println(list.size());
        for (String x : column) {
            model.addColumn(x);
        }
    ...
    private javax.swing.JButton buthem;
