 ...
 * @author DELL
 */
public class Xe_tai_admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quản lý Xe tải");
        ...
        jLabel11.setText("Trọng tải(tấn)");
                        ...
                        .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panxemayLayout.createSequentialGroup()
                                ...
                                .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(hang, javax.swing.GroupLayout.Alignment.TRAILING, 0, 115, Short.MAX_VALUE)
                                    .addComponent(mau, javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(gia, javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panxemayLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(sl, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
                                    .addComponent(tt, javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(nl)))
            ...
            .addGroup(panxemayLayout.createSequentialGroup()
                ...
                .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panxemayLayout.createSequentialGroup()
                        ...
                        .addGroup(panxemayLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(butcapnhat, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        panxemay.setVisible(true);
    ...
    private void butxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butxoaActionPerformed
        ...
        if(XetaiController.checkxeById(idxeclick)==false) {
        ...
        if(x==0) {
            if(XetaiController.xoaxeById(idxeclick)) {
    ...
    private void buthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buthemActionPerformed
        ...
        int namsx = Integer.parseInt(String.valueOf(nam.getSelectedItem()));
        String dungtich = nl.getText();
        String slphu = sl.getText();
        String giabanphu = gia.getText();
        String trongtaiphu = String.valueOf(tt.getText());
        int soluong; 
        int giaban;
        int trongtai;
        ...
        try {
            ...
            trongtai = Integer.parseInt(trongtaiphu);
            if(soluong < 0 || giaban < 0 || trongtai < 0) {
                JOptionPane.showMessageDialog(null, "Giá bán hoặc số lượng hoặc trọng tải không được để giá trị âm");
                return;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Giá bán hoặc số lượng hoặc trọng tải chưa đúng định dạng");
            return;
        }
        ...
        if(XemayController.checkxeById(idxe)) {
            ...
            if(XetaiController.luuxetai(idxe, tenxe, hangxe, mauxe, giaban, namsx, soluong,trongtai,dungtich)) {
    ...
    private void butcapnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butcapnhatActionPerformed
        ...
        String trongtaiphu = "" + bangchinh.getValueAt(rowclick, 7);
        ...
        if(XetaiController.checkxeById(idxe)==false) {
        ...
        try {
            ...
            trongtai = Integer.parseInt(trongtaiphu);
            if(soluong < 0 || giaban < 0 || trongtai < 0 || namsx < 0) {
        ...
        if(x==0) {
            if(XetaiController.updatexetai(idxe, tenxe, hangxe, mauxe, giaban, namsx, soluong, trongtai, nhienlieu)) {
